...
input variables file name when promted which is outside the Mosquito_stage_2.cpp folder

20-07-2023			//??????????????--------should we run the program for number of days based on the numer of rows in miami_date_temp file?
20-07-2023			what value should be considered for equlibrium value, as it effects the release of MALE DD mosqs,
					if it is 0 then the number of male_mosquioes on that day is used to calculate the count of release for entire simulation, which will be zero initially
...
#include <sstream>
#include <fstream>
//#include"Source_temp_and_date_loader.cpp"
#include <chrono>
#include<iomanip>
//#include"dev_and_mortality_calc.cpp"
//#include"Source_cc_and_date_reader.cpp"
//#include"Source_read_CC_vals.cpp"
//#include"Source_read_CC_vals_by_map.cpp"
